...
import { ProductImages } from '@/app/components/detail-page/image-gallery';
import { ProductInfo } from '@/app/components/detail-page/product-info';
import ProductTabs from '@/app/components/detail-page/producti-tab';
...
export default async function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const descriptionContent = (
        <div className="space-y-4">
            <p className="text-gray-600">
                ...
                featuring a significantly larger capacity and an optimized airflow design.
            </p>
    ...
    const specsContent = (
        <ul className="space-y-2 text-gray-600">
            <li><strong>Battery:</strong> 550mAh</li>
            <li><strong>E-liquid:</strong> 3.2mL</li>
            <li><strong>Nicotine:</strong> 50mg (5%)</li>
        </ul>
    );
    ...
    return (
        <main className="mx-auto max-w-[1440px] px-4 lg:px-8 py-12 bg-[#fcfcfc] min-h-screen">
            ...
            <nav className="flex text-[11px] font-medium text-gray-400 mb-8 items-center gap-2 tracking-wide uppercase">
                ...
                <span>›</span>
                <Link href="/collection" className="hover:text-black transition-colors">Disposable Vapes</Link>
                <span>›</span>
