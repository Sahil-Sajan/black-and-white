...
const OrderSummary = () => {
    ...
    const shipping = hasItems ? 5.00 : 0;
    ...
    return (
        <div className="w-full bg-zinc-50 border border-zinc-200">
            <div className="p-4 border-b border-zinc-200 bg-white">
                <h2 className="text-[11px] font-black uppercase tracking-widest text-black">Summary</h2>
            </div>
            ...
            <div className="p-6">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <Link href="/collection" className="w-full block text-center bg-zinc-100 text-zinc-500 py-4 text-[11px] font-black uppercase tracking-[0.2em] border border-zinc-200 hover:bg-zinc-200 transition-colors">
                        Continue Shopping
                    </Link>
                </div>
            </div>
