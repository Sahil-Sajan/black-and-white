...
import { TrendingUp, ShoppingBag, ShoppingCart, Package } from "lucide-react";
...
export default async function DashboardPage() {
  const { stats, monthlyData, recentOrders, recentProducts } = await getDashboardStats();
    ...
    <div className="flex flex-col gap-8 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="lg:col-span-2">
          <RevenueForecastChart data={monthlyData} />
        </div>

        {/* Top Selling Products takes up 1 part of the 3-column grid */}
        <div className="lg:col-span-1">
          <TopSellingProducts products={recentProducts} />
        </div>
      </div>
