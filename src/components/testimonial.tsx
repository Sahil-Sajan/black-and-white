    ...
    <section className="mx-auto max-w-[91.66%] px-4 py-20 bg-white">
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-2/3 relative group">
              ...
              return (
                <SwiperSlide key={product.id}>
                  <Link
                    ...
                    className="flex-col items-center text-center group/card block"
                  >
                    ...
                    <h3 className="text-[13px] font-bold text-zinc-800 line-clamp-2 min-h-10 px-2 leading-snug uppercase tracking-tight group-hover/card:text-red-600 transition-colors">
                      {product.name}
                    </h3>
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -left-6.25 -right-6.25 flex justify-between pointer-events-none z-20">
