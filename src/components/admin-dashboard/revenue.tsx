...
const RevenueForecastChart = () => {
    return (
        ...
        <div className="bg-white p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 shadow-sm flex-1 flex flex-col h-full min-h-[320px] md:min-h-[420px]">
            ...
            <div className="flex flex-row items-center justify-between mb-6 md:mb-8">
                <h3 className="text-lg md:text-xl font-black text-slate-800 tracking-tight">Revenue Forecast</h3>
