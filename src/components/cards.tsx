...
const products = [
  {
    id: 1,
    name: "VGOD Mix Iced Blue Razz Freebase E-Liquid 60ml",
    price: 2550,
    oldPrice: 3000,
    img: "/cards/card1.webp",
    sale: "-15%",
  },
  {
    id: 2,
    name: "VGOD Mix Iced Bubble Grapes Freebase E-Liquid 60ml",
    price: 2550,
    oldPrice: 3000,
    img: "/cards/card2.webp",
    sale: "-15%",
  },
  {
    id: 3,
    name: "VGOD Mix Iced Bubble Watermelon Freebase E-Liquid",
    price: 2550,
    oldPrice: 3000,
    img: "/cards/card3.jpg",
    sale: "-15%",
  ...
  {
    id: 4,
    name: "Juice Head Extra Freeze Apple Watermelon 100ml",
    price: 3825,
    oldPrice: 4500,
    img: "/cards/card4.jpg",
    sale: "-15%",
  ...
  {
    id: 5,
    name: "Vapetasia Killer Kustard Strawberry 60ml",
    price: 2800,
    oldPrice: 3200,
    img: "/cards/card5.webp",
    sale: "-10%",
  },
  {
    id: 6,
          ...
          return (
            <div key={product.id} className="group flex flex-col">
              ...
              <Link
                ...
                className="relative aspect-square w-full overflow-hidden bg-[#f9f9f9] rounded-sm block"
              >
